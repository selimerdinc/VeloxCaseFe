...
import {
  ...
  BarChart3, Calendar, Eye, EyeOff, Shield, Zap
} from 'lucide-react';
import './App.css';
...
function App() {
  ...
  // SETTINGS STATE (GÜNCELLENDİ)
  const [settingsTab, setSettingsTab] = useState('api'); // 'api' | 'security'
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      if (success > 0) {
        toast.success(`İşlem Tamamlandı!`, { id: tId });
        setJiraInput(''); fetchStats();
        setTimeout(() => setSyncResults([]), 5000);
      } else { toast.error("İşlem başarısız oldu.", { id: tId }); }
    ...
    <div className="app-container login-container">
      ...
      <div className="login-card">
        <div className="login-header">
           ...
           <h1>VeloxCase</h1><p>{isRegistering ? 'Yeni Hesap Oluşturun' : 'Yönetici Girişi'}</p>
        </div>
        <form onSubmit={handleAuth}>
          <div className="form-group"><label className="form-label">Kullanıcı Adı</label><input className="form-input" value={username} onChange={e=>setUsername(e.target.value)} placeholder="Kullanıcı Adı"/></div>
      ...
      <div className="main-wrapper">
        ...
        <div className="header-card">
          <div className="header-brand">
            ...
            <div className="brand-text"><h1>VeloxCase</h1><p>Kurumsal Test Entegrasyonu</p></div>
          </div>
